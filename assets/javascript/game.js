...
$(document).ready(function() {
  $("#randomNumberDisplay").text("Your random number is: " + randomNumber);
  ...
  $("#crystal_1").click(function() {
    ...
    if (crystalFirst == null) {
      crystalFirst = Math.floor(Math.random() * 12 + 1);
      crystalSecond = Math.floor(Math.random() * 12 + 1);
      crystalThird = Math.floor(Math.random() * 12 + 1);
      crystalFourth = Math.floor(Math.random() * 12 + 1);
